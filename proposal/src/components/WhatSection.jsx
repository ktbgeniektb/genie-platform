...
export default function WhatSection() {
  ...
  <div className="relative z-10 max-w-5xl mx-auto px-4">
        <h2 className="text-center font-aladdin text-5xl md:text-6xl text-[#F6E05E] drop-shadow mb-8">What</h2>
            ...
            学生には「自分らしい進路選択」を、<br />企業には「共鳴する人材との出会い」を、<br />教育機関には「先生が理想の教育に専念できる環境」と<br />「生徒が得意を活かせるキャリア発見の仕組み」を提供。<br />
    ...
    <div className="space-y-0">
        ...
        <TabPanel className="space-y-6">
            ...
            Lampは、「好きの本質」に気づく診断と対話を通して、進路選択に迷わないための“願いの言語化”を支援します。<br /><br />
        ...
        <TabPanel className="space-y-6">
            ...
            先生はカリキュラム進捗や面談データを効率的に管理でき、本質的な教育に時間を割けるようになります。  <br />
            一方、生徒は学習データや成果の可視化を通じて、自分の「得意」を発見し、<br />
            「好き」を目的に、「得意」を手段として活かすキャリアを描けます。 <br />
            「一律の進路指導」から「個性とビジョンを育む伴走型教育」への転換を後押しします。
            </p>
            </div>
        </TabPanel>
        </TabPanels>

...
const whyMeItems = [
  {
    ...
    content: (
      <>
        <p>
          私は15年間ダンスを学び続けてきました。<br />
          その中で、<span className="font-bold">自分が最も喜びを感じる瞬間</span>が、「ダンスを踊っている時」よりも
          <span className="font-bold">「ダンスを通して人の心を動かす瞬間」</span>だと気づきました。<br />
          ...
          さらに、自分の中に存在するさまざまな「好き」を整理し、その本質を探っていくことで、
          <span className="font-bold">生きる目的</span>や<span className="font-bold">大切にしたい価値観</span>までも浮かび上がってくるかもしれません。<br />
          こうした、コンテンツレベルではなく、本能から「好き」と感じられるものを見つけ、考えるきっかけをつくるのが、このLampです。
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          私は、小さい頃からデータを見るのが好きでした。<br />
          数字という手段によって、人の思いや行動のパターンが見えてくること、そしてそれは、
          <span className="font-bold">自分の「好きの本質」</span>である
          <span className="font-bold">「人の心が動く瞬間」を可視化したもの</span>であるということを、本能的に理解していたのだと思います。<br />
          ...
          しかし入社後、データ活用の中核と聞いていた「集客プラットフォーム ATSUMARU」が形骸化していることを知ります。自分がしたいと思っている
          <span className="font-bold">データサイエンス、そしてコンサルを含めたデータストラテジストの職業</span>は今、この会社にはありません。<br /><br />
          ...
          <span className="font-bold">
            「PDFに保存されたESを一つずつ見て、志望職種に「エンジニア」と書かれているESの数を数えないと分からない」
          </span>
          というものでした。<br />
          ...
          その<span className="font-bold">全てが叶うシステムを創る</span>、という考えから生まれたのがAtlasです。
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          私は小学生の頃、一時期「教員になりたい」と考えていました。<br />
          ...
          そして勉強の得意も科目レベルではなく、単元レベルで把握することが自己分析に繋がると考えています。<br />
        </p>
      </>
    ),
  },
...
export default function WhyMeAccordion() {
  return (
    <div>
      <section
        id="whyme"
        className="relative px-4 py-20 bg-[#0b1020] [background-image:radial-gradient(60%_40%_at_50%_0%,rgba(246,224,94,0.10),transparent_60%)]"
      >
        {/* 金の線 */}
        <span className="pointer-events-none absolute left-0 right-0 top-0 block h-[2px] bg-gradient-to-r from-transparent via-[#F6E05E] to-transparent opacity-80 z-20" />
        ...
        <div className="relative max-w-5xl mx-auto">
          <h2 className="text-center font-aladdin text-5xl md:text-6xl text-[#F6E05E] drop-shadow py-6">
            Why me
          </h2>

          {/* あなたの動機カード：ul/li に */}
          <div className="text-center text-lg md:text-xl leading-relaxed text-yellow-100/90 m-10">
            <div className="max-w-5xl mx-auto rounded-2xl border border-white/10 bg-white/10 backdrop-blur p-6 text-center m-6 mb-12">
              <ul className="text-left list-disc list-inside space-y-1">
                <li>会社が掲げる「個人ビジョン経営」を体現し、背中を示せる</li>
                <li>採用に力を入れ、採用コンサルを行う土壌があるからこそ活かせる</li>
                <li>ベンチャーである今、エンジニアグループの成長がそのまま会社の成長に直結する</li>
                <li>一人で案件を回すだけだったグループから「プラスを生み出すチーム」に進化させたい</li>
              </ul>
              <p className="mt-6">
              ...
              <p className="mt-6">
                ...
                私が<strong className="text-[#F6E05E]">新規事業</strong>を選んだのは、ただシステムをつくりたいからではありません。
              </p>
            </div>
          </div>

          {whyMeItems.map((item, index) => (
            <Disclosure key={index} as="div" className="overflow-hidden rounded-xl ring-1 ring-white/10 mb-3">
              {({ open }) => (
                <>
                  <DisclosureButton
                    className={`flex items-center justify-between w-full px-4 py-3 text-base md:text-lg font-semibold focus:outline-none transition
                      ${open ? "bg-yellow-500 text-black shadow-[0_0_40px_rgba(234,179,8,0.25)]" : "border border-yellow-400/50 text-yellow-200 hover:bg-yellow-500/10"}`}
                    aria-expanded={open}
                  >
                    ...
                    <DisclosurePanel as="div">
                      ...
                      >
                        <div className="px-4 pt-4 pb-5">
                          <div className="max-w-5xl mx-auto md:max-w-4xl bg-black/20 backdrop-blur-[2px] rounded-lg px-4 py-12">
                            {/* フォントサイズを統一：text-sm md:text-base */}
                            <div className="whitespace-pre-line leading-relaxed md:leading-loose text-sm md:text-base text-yellow-200 drop-shadow">
                              {item.content}
                            </div>
                          </div>
                        </div>
          ...
          <div className="text-center text-lg md:text-xl leading-relaxed text-yellow-100/90 m-10">
            Lampで「好き」を見つけ、Carpetで「得意」を見つけ、Atlasで最大限活かせる「環境」を見つける。<br />

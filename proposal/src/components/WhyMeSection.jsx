      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.06] mix-blend-overlay"
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="text-center text-lg md:text-xl leading-relaxed text-yellow-100/90 m-10">
            <div className="max-w-5xl mx-auto rounded-2xl border border-white/10 bg-white/10 backdrop-blur p-6 space-y-4 text-center m-6 mb-12">
